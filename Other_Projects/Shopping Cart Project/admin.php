...
<?php include('/home/scrabbler/Jatin/Other_Projects/Shopping Cart Project/include/admin/header.php');?>
    <section>
		<div class="container">
			<div class="row">
				<?php include('/home/scrabbler/Jatin/Other_Projects/Shopping Cart Project/include/admin/sidebar.php');?>
    ...
    <div class="col-sm-9 padding-right">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<tbody>
						<?php
							include('/home/scrabbler/Jatin/Other_Projects/Shopping Cart Project/db.php');
...
<?php include('/home/scrabbler/Jatin/Other_Projects/Shopping Cart Project/include/admin/footer.php'); ?>
