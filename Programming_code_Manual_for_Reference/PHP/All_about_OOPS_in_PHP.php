...
class Car {
    ...
    ** The child classes that inherit from abstract classes must add bodies to the abstract methods
    ...
    1. Can not instantiate an abstract class
    - classes defined as abstract may not be instantiated(no object for them) and any class that contains at least one abstract method must also be abstract
    ...
    - abstract classes can have abstract and non-abstract methods but it must contain at least one abstract method
    ...
    - When inheriting from an abstract class, all methods marked abstract in the parent's class declaration must be defined by the child; additionally with same or less visibility

    Eg - if the abstract method is defined as protected, the function implementation must be defined as either protected or public , but not private

    ** an abstract method should not be private
    ...
    6. Signatures of the abstract method must match
    - When inheriting from an abstract class, all methods marked abstract in the parent's class declaration must be defined by the child; the signatures of the methods must match ,i.e., the type hints and the number of required arguments must be same

    Eg - if the child class defined an optional argument, where the abstract method's signature does not, there is no conflict in the signature
    ...
    - Abstract classes can extend another abstract class
    - can provide implementation of interface
    - but it doesn't support multiple inheritance
    ...
    <!-- When should one implement abstract classes -->

    - to define and partially implement common tasks that extended classes should do
    ...
    ** we can implement more than one interface in the same class
    ...
    class Boeing 747 extends Plane implements Fliers
    {
        public function fly()
        {
    ...
    ** Boeing 747 is a Plane that can fly and Tweety is a bird that can fly but doesn't open doors
    ...
    ** To implement it ,we can choose between abstract classes and interfaces
    ...
    class Driver {}
        ...
        ** The following code can only work in PHP 7
        ...
        <!-- How can we loosen visibility of methods in parent and child classes -->

        - Child classes may only loosen the visibility
        ...
        - A constructor is a function that is executed after the object has been initialized (its memory allocated, instance properties copied etc)
        - its purpose is to put the object in a valid state

        - an object, to be in a usable state, requires some data
        - The purpose of the constructor is to force this data to be given to the object at the instantiation time and disallow any instances without such data
        ...
        ** $this is a reference to the current object
        ...
        - Overloading is defining the functions have similar signatures, yet have different parameters
        - Overriding is replacing the function in the parent class with that of the object class
...
** above is not yet supported in PHP

Alternative is to use optional arguments
